(function (waitForDependencies) {
    waitForDependencies(function ($, DjangoPagedown) {
    ...
    function checkDependencies() {
        if (typeof django !== "undefined" && typeof django.jQuery !== "undefined" && typeof DjangoPagedown !== "undefined") {
            callback(django.jQuery, DjangoPagedown);
        } else {
            setTimeout(checkDependencies, 50); // Retry after 50ms
        }
    }
    checkDependencies();
});